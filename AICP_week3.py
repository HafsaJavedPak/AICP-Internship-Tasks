...
class Cow:
    days = {
        1: "Monday - 1st milking",
        2: "Monday - 2nd milking",
        3: "Tuesday - 1st milking",
        4: "Tuesday - 2nd milking",
        5: "Wednesday - 1st milking",
        6: "Wednesday - 2nd milking",
        7: "Thursday - 1st milking",
        8: "Thursday - 2nd milking",
        9: "Friday - 1st milking",
        10: "Friday - 2nd milking",
        11: "Saturday - 1st milking",
        12: "Saturday - 2nd milking",
        13: "Sunday - 1st milking",
        14: "Sunday - 2nd milking",
    }
    
    milking_time = 1  # Start from 1
    yield_weekly = 0
    yield_average = 0
    ...
    def milk_cow(self):
        # week is finished
        if self.milking_time > 14:
            self.milking_time = 1  # Reset to 1 for next week
            self.yield_average = mean(self.yield_total)
            self.yield_weekly = sum(self.yield_total)
        yield_amount = round(float(input(f"Enter the volume of milk milked from cow {self.cow_id} for {self.days[self.milking_time]}:\n")), 1)
        self.yield_total[self.milking_time - 1] = yield_amount
        self.milking_time += 1
